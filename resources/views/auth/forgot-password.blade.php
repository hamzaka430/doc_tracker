...
<head>
    ...
    <title>Forgot Password - Doc Tracker</title>
    ...
    <div class="forgot-container">
        <div class="forgot-card">
            <div class="forgot-header">
                <h1><i class="fas fa-key text-primary"></i> Forgot Password</h1>
                <p>No problem! Enter your email address and we'll send you a password reset link.</p>
            </div>
